...
class AnalysisController extends Controller {
    ...
    async getAnalysislist() {
        ...
        const result = await ctx.service.wx.analysis.getAnalysislist(appId, beginTime, endTime, ip, pageNo, pageSize);
    ...
    async getAnalysisOneList() {
        ...
        const result = await ctx.service.wx.analysis.getAnalysisOneList(appId, markuser);
    ...
    async getTopDatas() {
        ...
        const result = await ctx.service.wx.analysis.getTopDatas(appId, beginTime, endTime, type);
        ctx.body = this.app.result({
            data: result,
        });
    }
    ...
    async getProvinceAvgCount() {
        ...
        const result = await ctx.service.wx.analysis.getProvinceAvgCount(appId, beginTime, endTime, type);
        ctx.body = this.app.result({
            data: result,
        });
    }
