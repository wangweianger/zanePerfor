...
class SystemController extends Controller {
    ...
    async getWebSystemList() {
        ...
        const result = await ctx.service.web.webSystem.getWebSystemList();
        ctx.body = this.app.result({
            data: result,
        });
    }
    ...
    async deleteWebSystemUser() {
        ...
        const result = await ctx.service.web.webSystem.deleteWebSystemUser(appId, userToken);
    ...
    async addWebSystemUser() {
        ...
        const result = await ctx.service.web.webSystem.addWebSystemUser(appId, userToken);
    ...
    async deleteSystem() {
        ...
        const result = await ctx.service.web.webSystem.deleteSystem(appId);
